...
model = keras.models.load_model(r'saved-model\model1\EfficientNetB0-skin disease-92.10.h5')
...
def classify1():
    ...
    csv_path=r'saved-model\model1\class_dict (2).csv' # path to class_dict.csv
    model_path=r'saved-model\model1\EfficientNetB0-skin disease-92.10.h5' # path to the trained model
...
def classify2():
    ...
    cv2.imwrite(dst_path, img)
    print (os.listdir(store_path))
    csv_path=r'saved-model\model2\class_dict (1).csv' # path to class_dict.csv
    model_path=r'saved-model\model2\EfficientNetB0-skin disease-94.70.h5' # path to the trained model
    class_name, probability=predictor(store_path, csv_path,  model_path, crop_image = False) # run the classifier
...
def classify3():
    ...
    cv2.imwrite(dst_path, img)
    print (os.listdir(store_path))
    csv_path=r'saved-model\model3\class_dict (3).csv' # path to class_dict.csv
    model_path=r'saved-model\model3\EfficientNetB2-skin disease-95.55.h5' # path to the trained model
    class_name, probability=predictor(store_path, csv_path,  model_path, crop_image = False) # run the classifier
...
def classify4():
    ...
    cv2.imwrite(dst_path, img)
    print (os.listdir(store_path))
    csv_path=r'saved-model\model4\class_dict (4).csv' # path to class_dict.csv
    model_path=r'saved-model\model4\EfficientNetB2-skin disease-92.06.h5' # path to the trained model
    class_name, probability=predictor(store_path, csv_path,  model_path, crop_image = False) # run the classifier
